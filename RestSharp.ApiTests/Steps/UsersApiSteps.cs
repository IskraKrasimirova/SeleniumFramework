...
using StringUtils = RestSharp.ApiTests.Utilities.Types.StringUtils;
...
namespace RestSharp.ApiTests.Steps
{
    ...
    public class UsersApiSteps
    {
        ...
        private readonly IApiUserFactory _userFactory;

        public UsersApiSteps(ScenarioContext scenarioContext, UsersApi usersApi, IApiUserFactory userFactory)
        {
